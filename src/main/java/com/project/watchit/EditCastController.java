...
public class EditCastController {
    private Stage stage;
    private Scene scene;
    ...
    @FXML
    public void handleEditCast(ActionEvent event) {
        ...
        try {
            admin.editCast(firstName, lastName, newFirstName, newLastName, nationality, gender, dateOfBirth);

            showAlert(AlertType.INFORMATION, "Success", "actor.txt member updated successfully!");
